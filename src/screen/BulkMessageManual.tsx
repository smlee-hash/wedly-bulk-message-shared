        ...
        <section ref={bindSection("overview")} id={domId("overview")} className="grid gap-3.5 scroll-mt-4">
          ...
          <div className="grid gap-2">
            <Row
              label="이메일로 보낼 때"
              items={[
                "1단계에서 「이메일」 또는 「둘 다」를 고르면 주소가 있는 분만 대상이 됩니다",
                "정보성 안내만 보내며, 광고로 읽히는 문장이 있으면 발송이 잠깁니다",
                "사실 잠금 상자의 빨간 줄과 [확인 필요]를 모두 풀어야 다음으로 갈 수 있습니다",
                "「확인함」이 믿을 수 있는 신호입니다 — 링크·버튼을 실제로 누른 것만 확인이고, 도착만으로 읽었다고 말하지 않습니다",
              ]}
            />
            <Row
              label="주의"
              items={[
                "첨부는 보관함 링크(14일)로 들어갑니다. 잘못 보냈으면 발송을 중단해 링크를 끊을 수 있습니다",
                "수신 설정을 누른 분은 다음 발송 대상에서 자동으로 빠지고 「수신거부 N명 제외」로 보입니다",
              ]}
            />
          </div>
        </section>
